...
import com.foodie.payment.wx.entity.PayResult;
...
public class NotifyController {
    ...
    public String alipay(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        boolean signVerified = AlipaySignature.rsaCheckV1(params, aliPayResource.getAlipayPublicKey(),
                aliPayResource.getCharset(), aliPayResource
                .getSignType()); //调用SDK验证签名
        ...
        if(signVerified){//验证成功
            ...
            if(trade_status.equals("TRADE_SUCCESS")){
                String merchantReturnUrl = paymentOrderService.updateOrderPaid(out_trade_no,
                        CurrencyUtils.getYuan2Fen(total_amount));
